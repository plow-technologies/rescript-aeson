...
var Aeson_json = require("./Aeson_json.js");
...
var DecodeError = Caml_exceptions.create("Aeson_json_decode.DecodeError");
...
function bool(json) {
  if (typeof json === "boolean") {
    ...
    throw [
          DecodeError,
          "Expected boolean, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function $$float(json) {
  if (typeof json === "number") {
    ...
    throw [
          DecodeError,
          "Expected number, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function $$int(json) {
  ...
  if (_isInteger(f)) {
    ...
    throw [
          DecodeError,
          "Expected int, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function int32(json) {
  ...
  if (_isInteger(f)) {
    ...
    throw [
          DecodeError,
          "Expected int32, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function nativeint(json) {
  ...
  if (_isInteger(f)) {
    ...
    throw [
          DecodeError,
          "Expected nativeint, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function string(json) {
  if (typeof json === "string") {
    ...
    throw [
          DecodeError,
          "Expected string, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function date(json) {
  if (typeof json === "string") {
    ...
    throw [
          DecodeError,
          "Expected date, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function nullAs(value, json) {
  if (json === null) {
    ...
    throw [
          DecodeError,
          "Expected null, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function array(decode, json) {
  if (Array.isArray(json)) {
    ...
    throw [
          DecodeError,
          "Expected array, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function dict(decode, json) {
  if (typeof json === "object" && !Array.isArray(json) && json !== null) {
    ...
    throw [
          DecodeError,
          "Expected object, got " + Aeson_json.stringify(json)
        ];
  }
}
...
function result(decodeA, decodeB, json) {
  var match = Aeson_json.decodeObject(json);
  if (match) {
    var o = match[0];
    var match$1 = o["Ok"];
    if (match$1 !== undefined) {
      ...
      if (match$2 !== undefined) {
        ...
        throw [
              DecodeError,
              "Expected object with a \"Ok\" key or \"Error\" key, got " + Aeson_json.stringify(json)
            ];
      }
    }
  } else {
  ...
  if (match) {
    ...
    if (match$1 !== undefined) {
      ...
      if (match$2 !== undefined) {
        ...
        throw [
              DecodeError,
              "Expected object with a \"Left\" key or \"Right\" key, got " + Aeson_json.stringify(json)
            ];
      }
    }
  } else {
...
function oneOf(_decoders, json) {
  while(true) {
    ...
    if (decoders) {
      ...
      throw [
            DecodeError,
            "Expected oneOf " + (String(length) + ", got ") + Aeson_json.stringify(json)
          ];
    }
  };
}
...
function int64_of_array(json) {
  ...
  if (fs.length === 2) {
    if (_isInteger(Caml_array.caml_array_get(fs, 0)) && _isInteger(Caml_array.caml_array_get(fs, 1))) {
      ...
      throw [
            DecodeError,
            "Expected int64, got " + Aeson_json.stringify(json)
          ];
    }
  } else {
    throw [
...
function int64(json) {
  ...
  try {
    ...
    if (exn[0] === DecodeError) {
      ...
      var s$1;
      try {
        s$1 = string(Aeson_json.stringify(json));
        exit$1 = 2;
      }
      catch (raw_exn$1){
        ...
        if (exn$1[0] === DecodeError) {
          throw [
                DecodeError,
                "Expected int64 as string, got " + Aeson_json.stringify(json)
              ];
        } else {
          throw exn$1;
        }
