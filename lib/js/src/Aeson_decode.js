...
var Aeson_compatibility     = require("./Aeson_compatibility.js");
...
function rational(json) {
  var match = Js_json.decodeObject(json);
  if (match) {
    var o = match[0];
    var match$1 = o["numerator"];
    if (match$1 !== undefined) {
      var match$2 = o["denominator"];
      if (match$2 !== undefined) {
        return Aeson_compatibility.Rational[/* make */0]($$int(match$1), $$int(match$2));
      } else {
        throw [
              DecodeError,
              "Expected object with \"numerator\" key and int value and \"denominator\" key and int value, got " + JSON.stringify(json)
            ];
      }
    } else {
      throw [
...
/* Aeson_compatibility Not a pure module */
