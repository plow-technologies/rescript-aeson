...
function beltMapInt(decodeValue, json) {
  ...
  try {
    decoded_array = array((function (param) {
            return pair($$int, decodeValue, param);
          }), json);
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
  ...
  return Belt_MapInt.fromArray(decoded_array);
}
...
function beltMapString(decodeValue, json) {
  ...
  try {
    decoded_array = array((function (param) {
            return pair(string, decodeValue, param);
          }), json);
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
  ...
  return Belt_MapString.fromArray(decoded_array);
}
