...
Jest.describe("array", (function () {
        Jest.test("array with int", (function () {
                return jsonRoundtripSpec((function (json) {
                              ...
                              return Aeson_encode.array((function (prim) {
                                            return prim;
                                          }), arr);
                            }), JSON.parse("[1, 2, 3, 4, 5]"));
              }));
        Jest.test("array with string", (function () {
                return jsonRoundtripSpec((function (json) {
                              return Aeson_decode.wrapResult((function (j) {
        ...
        Jest.test("array with bool", (function () {
                return jsonRoundtripSpec((function (json) {
                              return Aeson_decode.wrapResult((function (j) {
        ...
        Jest.test("array with float", (function () {
                return jsonRoundtripSpec((function (json) {
                              return Aeson_decode.wrapResult((function (j) {
                                            return Aeson_decode.array(Aeson_decode.$$float, j);
                                          }), json);
                            }), (function (arr) {
                              return Aeson_encode.array(Aeson_encode.$$float, arr);
                            }), JSON.parse("[1.5, 2.7, 3.14159, 42.0]"));
              }));
        Jest.test("array with nested arrays", (function () {
                return jsonRoundtripSpec((function (json) {
                              return Aeson_decode.wrapResult((function (j) {
                              ...
                              return Aeson_encode.array((function (innerArr) {
                                            return Aeson_encode.array((function (prim) {
                                                          return prim;
                                                        }), innerArr);
                                          }), arr);
        ...
        Jest.test("array with objects", (function () {
                return jsonRoundtripSpec((function (json) {
                              return Aeson_decode.wrapResult((function (j) {
                                            return Aeson_decode.array((function (json) {
                              ...
                              return Aeson_encode.array((function (dict) {
        ...
        Jest.test("array with optional values", (function () {
                return jsonRoundtripSpec((function (json) {
                              return Aeson_decode.wrapResult((function (j) {
                                            return Aeson_decode.array((function (json) {
                              ...
                              return Aeson_encode.array((function (val) {
