...
Jest.test("array int", (function () {
        return Jest.Expect.toEqual(Jest.Expect.expect(Aeson_encode.array((function (prim) {
                              return prim;
                            }), [
                            1,
                            2,
...
Jest.test("array float", (function () {
        return Jest.Expect.toEqual(Jest.Expect.expect(Aeson_encode.array(Aeson_encode.$$float, [
                            1.5,
                            2.7,
                            3.14
                          ])), [
...
Jest.test("array empty", (function () {
        return Jest.Expect.toEqual(Jest.Expect.expect(Aeson_encode.array((function (prim) {
                              return prim;
                            }), [])), []);
      }));

Jest.test("array nullable", (function () {
        var result = Aeson_encode.array((function (v) {
        ...
        var expected = JSON.parse("[1, null, 3]");
        return Jest.Expect.toEqual(Jest.Expect.expect(result), expected);
      }));

Jest.test("array nested", (function () {
        return Jest.Expect.toEqual(Jest.Expect.expect(Aeson_encode.array((function (arr) {
