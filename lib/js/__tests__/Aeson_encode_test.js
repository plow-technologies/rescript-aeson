...
Jest.test("string Belt.Map.Int.t", (function (param) {
        ...
        return Jest.Expect.toEqual(arr, Jest.Expect.expect(Aeson_encode.beltMapInt((function (prim) {
                              return prim;
                            }), bm)));
      }));
...
Jest.test("string Belt.Map.String.t", (function (param) {
        ...
        return Jest.Expect.toEqual(arr, Jest.Expect.expect(Aeson_encode.beltMapString((function (prim) {
                              return prim;
                            }), bm)));
      }));
