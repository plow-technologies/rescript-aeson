...
Jest.test("onpingKey string Belt.Map.t (encoded as dictionary)", (function (param) {
        ...
        var bm = Belt_Map.fromArray(arrWithKey, OnpingKeyComparable);
        return Jest.Expect.toEqual(Js_dict.fromArray(arr), Jest.Expect.expect(Aeson_encode.beltMap1(encodeOnpingKey, (function (prim) {
                              return prim;
                            }), bm)));
      }));
...
Jest.test("pid string Belt.Map.t (encoded as dictionary)", (function (param) {
        ...
        return Jest.Expect.toEqual(Js_dict.fromArray($$Array.map((function (param) {
                            ...
                            }), arr)), Jest.Expect.expect(Aeson_encode.beltMap1(encodePid, (function (prim) {
                              return prim;
                            }), bm)));
      }));
