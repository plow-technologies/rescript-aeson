...
describe("singleEnumerator", (function () {
        return Jest.test("singleEnumerator", (function () {
                      return Jest.Expect[/* toEqual */12](/* TypeParameterRef0 */0)(Jest.Expect[/* expect */0](Aeson_decode.singleEnumerator(/* TypeParameterRef0 */0, /* array */[])));
                    }));
      }));
...
describe("either", (function () {
        Jest.test("object with field", (function () {
                return Jest.Expect[/* toEqual */12](2)(Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.$$int, (function (param) {
                                        return Aeson_decode.field("x", Aeson_decode.$$int, param);
                                      }))(JSON.parse(" { \"x\": 2} "))));
              }));
        Jest.test("int", (function () {
                return Jest.Expect[/* toEqual */12](23)(Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.$$int, (function (param) {
                                        return Aeson_decode.field("x", Aeson_decode.$$int, param);
                                      }))(23)));
              }));
        return throws(/* None */0, Aeson_decode.either(Aeson_decode.$$int, (function (param) {
                          return Aeson_decode.field("x", Aeson_decode.$$int, param);
                        })), /* :: */[
                    /* Bool */6,
                    /* :: */[
