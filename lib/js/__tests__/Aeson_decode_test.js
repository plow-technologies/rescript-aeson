...
Jest.describe("float", (function () {
        ...
        Jest.test("float", (function () {
                return Jest.Expect.toEqual(Jest.Expect.expect(Aeson_decode.$$float("Infinity")), Number("Infinity"));
              }));
        Jest.test("float", (function () {
                return Jest.Expect.toEqual(Jest.Expect.expect(Aeson_decode.$$float("+Infinity")), Number("Infinity"));
              }));
...
Jest.describe("bigint", (function () {
        ...
        Jest.test("invalid string should throw", (function () {
                return Jest.Expect.toThrow(Jest.Expect.expect(function () {
                                return Aeson_decode.bigint("not-a-number");
                              }));
              }));
        Jest.test("float string should throw", (function () {
                return Jest.Expect.toThrow(Jest.Expect.expect(function () {
                                return Aeson_decode.bigint("123.45");
                              }));
              }));
        Jest.test("string with text should throw", (function () {
                return Jest.Expect.toThrow(Jest.Expect.expect(function () {
                                return Aeson_decode.bigint("123abc");
                              }));
              }));
        Jest.test("string with decimal point should throw", (function () {
                return Jest.Expect.toThrow(Jest.Expect.expect(function () {
                                return Aeson_decode.bigint("123.0");
                              }));
              }));
        throws(undefined, Aeson_decode.bigint, {
              hd: "Bool",
              tl: {
                hd: "Float",
                tl: {
