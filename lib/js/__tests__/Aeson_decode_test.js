...
describe("either", (function () {
        Jest.test("either - left int", (function () {
                return Jest.Expect[/* toEqual */12](Aeson_compatibility.Either[/* left */0](1), Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.$$int, Aeson_decode.string, Aeson_encode.either((function (prim) {
                                          return prim;
                                        }), (function (prim) {
                                          return prim;
        ...
        Jest.test("either - left string", (function () {
                return Jest.Expect[/* toEqual */12](Aeson_compatibility.Either[/* left */0]("hello"), Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.string, Aeson_decode.$$int, Aeson_encode.either((function (prim) {
                                          return prim;
                                        }), (function (prim) {
                                          return prim;
        ...
        Jest.test("either - right int", (function () {
                return Jest.Expect[/* toEqual */12](Aeson_compatibility.Either[/* right */1](1), Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.string, Aeson_decode.$$int, Aeson_encode.either((function (prim) {
                                          return prim;
                                        }), (function (prim) {
                                          return prim;
                                        }), Aeson_compatibility.Either[/* right */1](1)))));
              }));
        return Jest.test("either - right string", (function () {
                      return Jest.Expect[/* toEqual */12](Aeson_compatibility.Either[/* right */1]("hello"), Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.$$int, Aeson_decode.string, Aeson_encode.either((function (prim) {
                                                return prim;
                                              }), (function (prim) {
                                                return prim;
...
describe("rational", (function () {
        ...
        return Jest.test("rational", (function () {
                      return Jest.Expect[/* toEqual */12](Aeson_compatibility.Rational[/* make */0](2131774217, -731653816), Jest.Expect[/* expect */0](Aeson_decode.rational(Aeson_encode.rational(Aeson_compatibility.Rational[/* make */0](2131774217, -731653816)))));
                    }));
      }));
