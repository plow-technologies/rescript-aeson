...
describe("int64", (function () {
        Jest.test("int64", (function () {
                return Jest.Expect[/* toEqual */12](/* int64 */[
                            /* hi */0,
                            /* lo */23
                          ], Jest.Expect[/* expect */0](Aeson_decode.int64(/* int64 */[
                                    /* hi */0,
                                    /* lo */23
                                  ])));
              }));
        Jest.test("int64", (function () {
                return Jest.Expect[/* toEqual */12](Caml_format.caml_int64_of_string("9223372036854775807"), Jest.Expect[/* expect */0](Aeson_decode.int64(Caml_format.caml_int64_of_string("9223372036854775807"))));
              }));
...
describe("optional", (function () {
        ...
        Jest.test("int64 -> int64", (function () {
                return Jest.Expect[/* toEqual */12](/* Some */[/* int64 */[
                              /* hi */0,
                              /* lo */64
                            ]], Jest.Expect[/* expect */0](Aeson_decode.optional(Aeson_decode.int64, /* int64 */[
                                    /* hi */0,
                                    /* lo */64
                                  ])));
              }));
...
describe("either", (function () {
        Jest.test("Right", (function () {
                return Jest.Expect[/* toEqual */12](/* Ok */Block.__(0, ["hello"]), Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.$$int, Aeson_decode.string, JSON.parse(" {\"Right\": \"hello\"} "))));
              }));
        return Jest.test("Left", (function () {
                      return Jest.Expect[/* toEqual */12](/* Error */Block.__(1, [2]), Jest.Expect[/* expect */0](Aeson_decode.either(Aeson_decode.$$int, Aeson_decode.string, JSON.parse(" {\"Left\": 2} "))));
                    }));
      }));
