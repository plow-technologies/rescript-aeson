...
describe("int64", (function () {
        Jest.test("int64 string", (function () {
        ...
        console.log(23);
        console.log(Aeson_decode.int64(23));
        Jest.test("int64 int", (function () {
                return Jest.Expect[/* toEqual */12](/* int64 */[
                            /* hi */0,
                            /* lo */23
                          ], Jest.Expect[/* expect */0](Aeson_decode.int64(23)));
              }));
        return Jest.test("int64 Obj.magic", (function () {
...
describe("product type with decoder", (function () {
        var json = JSON.parse(" { \"name\": \"Lars\", \"age\": 35 } ");
        return Jest.test("int -> float andThen int", (function () {
                      return Jest.Expect[/* toEqual */12](json, Jest.Expect[/* expect */0](encodeUser(/* record */[
                                          /* name */"Lars",
                                          /* age */35
                                        ])));
                    }));
