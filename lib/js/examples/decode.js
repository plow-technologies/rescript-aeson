...
function mapJsonObjectString(f, decoder, encoder, str) {
  ...
  return JSON.stringify(Js_dict.map((function (v) {
                    return encoder(v);
                  }), Js_dict.map((function (v) {
                        return f(v);
                      }), Aeson_decode.dict(decoder, json))));
}
...
console.log(mapJsonObjectString(sum, (function (extra) {
            return Aeson_decode.array(Aeson_decode.$$int, extra);
          }), (function (prim) {
            return prim;
          }), "\n      {\n        \"foo\": [1, 2, 3],\n        \"bar\": [9, 8, 7]\n      }\n    "));
